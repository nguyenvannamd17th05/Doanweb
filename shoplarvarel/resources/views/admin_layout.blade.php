...
<head>
    ...
    <link rel="stylesheet" href="{{asset('./styling/css/morris.css')}}" type="text/css"/>
    <!-- calendar -->
    <link rel="stylesheet" href="{{asset('./styling/css/monthly.css')}}">
    <!-- //calendar -->
    <!-- //font-awesome icons -->
    <script src="{{asset('./styling/js/jquery2.0.3.min.js')}}"></script>
    <script src="{{asset('./styling/js/raphael-min.js')}}"></script>
    <script src="{{asset('./styling/js/morris.js')}}"></script>
</head>
<body>
    <section id="container">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="{{asset('./styling/images/2.png')}}">
                            <span class="username">
                                <?php
                ...
                <div id="sidebar" class="nav-collapse">
                    ...
                    <div class="leftside-navigation">
                        <ul class="sidebar-menu" id="nav-accordion">
                            <li>
                                <a class="active" href="{{URL::to('admin-index')}}">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a href="{{URL::to('add-category')}}">Add CategoryProduct</a></li>
                                    <li><a href="{{URL::to('all-category')}}">List CategoryProduct</a></li>
                                </ul>
                            </li>
                            <li class="sub-menu">
                                <a href="javascript:;">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a href="{{URL::to('m-order')}}">List orders</a></li>  
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <section id="main-content">
                ...
                <div class="footer">
                    <div class="wthree-copyright">
                        <p>© 2017 Visitors. All rights reserved | Design by <a href="http://fb.com/deft.nvn">Nguyen Nam</a></p>
                    </div>
                </div>
                <!-- / footer -->
            </section>
        ...
        <script src="{{asset('./styling/js/jquery.scrollTo.js')}}"></script>
        <!-- morris JavaScript -->
        <script>
